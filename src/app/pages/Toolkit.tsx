...
export function Toolkit() {
  ...
  return (
    <div>
      ...
      {banner && (
        <div className="max-w-[1440px] mx-auto px-6 py-4 md:px-12 border-b border-border/10">
      ...
      <section className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 pb-28 md:pb-36">
        ...
        {features.map(group => (
          <div key={group.group}>
            {/* Group label */}
            <div className="grid grid-cols-[1fr_100px_120px] md:grid-cols-[1fr_130px_160px] border-b border-border/10 py-6">
            ...
            {group.rows.map(row => (
              <div key={row.label}
                className="grid grid-cols-[1fr_100px_120px] md:grid-cols-[1fr_130px_160px] border-b border-border/10 py-5 items-center">
        ...
        <div className="grid grid-cols-[1fr_100px_120px] md:grid-cols-[1fr_130px_160px] pt-10 gap-4">
          ...
          <div className="flex items-start justify-center pt-1">
            <button
              ...
              className="text-[9px] tracking-[0.15em] uppercase text-muted-foreground border-b border-border/40 pb-px hover:text-foreground hover:border-foreground/20 transition-colors whitespace-nowrap bg-transparent border-0 border-b cursor-pointer p-0">
              Start free →
            </button>
          </div>
          <div className="flex items-start justify-center pt-1">
            <button
              ...
              className="text-[9px] tracking-[0.15em] uppercase text-foreground border-b border-foreground/20 pb-px hover:border-foreground/40 transition-colors whitespace-nowrap bg-transparent border-0 border-b cursor-pointer p-0">
              Get Toolkit — £97 →
            </button>
          </div>
        </div>
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 py-28 md:py-36">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-y-16 md:gap-x-16 lg:gap-x-24">
            {[
              ...
              <div key={t.name} className="reveal border-t border-border/10 pt-8">
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 py-28 md:py-36">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-8 gap-y-10">
            {[
              ...
              <div key={s.n} className="reveal border-t border-border/10 pt-6">
          ...
          <div className="mt-24 pt-12 border-t border-border/10 flex flex-wrap gap-8 items-center justify-between reveal">
            ...
            <div className="flex flex-wrap gap-8">
              <button
                onClick={() => navigate('/toolkit/property-passport')}
                className="text-[10px] tracking-[0.15em] uppercase text-muted-foreground border-b border-border/40 pb-px hover:text-foreground hover:border-foreground/20 transition-colors bg-transparent border-0 border-b cursor-pointer p-0">
                Start free →
              </button>
              <button
                onClick={() => { window.location.href = STRIPE_TOOLKIT_LINK; }}
                className="text-[10px] tracking-[0.15em] uppercase text-foreground border-b border-foreground/20 pb-px hover:border-foreground/40 transition-colors bg-transparent border-0 border-b cursor-pointer p-0">
