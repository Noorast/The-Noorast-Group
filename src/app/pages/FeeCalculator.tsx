              ...
              <div style={{ animation: 'fadeIn 0.3s ease' }}>
                ...
                <div className="mt-6 pt-6 border-t border-border/40 bg-muted/10 p-6">
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    <a href="/toolkit/property-passport" className="inline-flex items-center gap-2 px-5 py-2.5 border border-foreground/30 text-foreground text-[10px] tracking-[0.12em] uppercase hover:border-foreground/40 transition-colors" style={{ textDecoration: 'none' }}>
                      Try free first
                    </a>
                  </div>
                </div>
