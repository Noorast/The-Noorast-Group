...
export function Practice() {
  ...
  return (
    <div>
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 flex justify-between py-4 border-b border-border/10">
        <span className="text-[9px] tracking-[0.2em] uppercase text-muted-foreground/50">London, United Kingdom</span>
        <span className="text-[9px] tracking-[0.2em] uppercase text-muted-foreground/50">London</span>
      </div>
            ...
            <div className="reveal">
              ...
              <div className="space-y-8">
                {[
                  ...
                  <div key={item.label} className="border-t border-border/10 pt-6">
      ...
      <section className="border-t border-border/10">
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 py-20 md:py-28 flex flex-wrap items-center justify-between gap-8">
          ...
          <div className="flex flex-wrap gap-8">
            <Link to="/toolkit"
              className="text-[10px] tracking-[0.15em] uppercase text-muted-foreground border-b border-border/40 pb-px hover:text-foreground hover:border-foreground/20 transition-colors">
              View the Toolkit →
            </Link>
            <Link to="/contact"
