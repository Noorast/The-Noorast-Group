    ...
    <div>
      ...
      <section className="border-t border-border/10">
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 py-20 md:py-28 flex flex-wrap items-center justify-between gap-8">
          ...
          <Link to="/contact"
            className="text-[10px] tracking-[0.15em] uppercase text-foreground border-b border-foreground/20 pb-px hover:border-foreground/40 transition-colors whitespace-nowrap">
            Discuss a project →
          </Link>
        </div>
      </section>
