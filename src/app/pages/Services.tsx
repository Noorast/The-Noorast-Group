...
export function Services() {
  ...
  return (
    <div>
      ...
      {/* Header */}
      <section className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 pt-20 pb-20 md:pt-28 md:pb-28 border-b border-border/10">
      ...
      <section className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 pt-24 pb-20 md:pt-32 md:pb-28">
        ...
        {[
          ...
          <Link key={item.path} to={item.path}
            className="group border-t border-border/10 py-8 flex flex-wrap md:flex-nowrap gap-6 md:gap-16 items-start reveal block"
      ...
      {/* ── 02 DESIGN SERVICES ───────────────────────────────── */}
      <section className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 pt-24 pb-20 md:pt-32 md:pb-28 border-t border-border/10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-24">
          ...
          <div className="lg:col-span-7 lg:pl-16 reveal">
            <div className="border-t border-border/10 pt-10 mb-8">
              ...
              <Link to="/contact"
                className="text-[10px] tracking-[0.15em] uppercase text-foreground border-b border-foreground/20 pb-px hover:border-foreground/40 transition-colors">
        ...
        <div className="border-t border-border/10 pt-12 mt-4 flex flex-wrap items-center justify-between gap-8 reveal">
