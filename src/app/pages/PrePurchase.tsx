        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
          ...
          <div className="border border-border p-8">
            ...
            <div className="mt-6 pt-6 border-t border-border/40 space-y-3">
              ...
              <Link to="/toolkit/property-passport" className="inline-block text-[10px] tracking-[0.12em] uppercase border-b border-foreground/30 pb-0.5 hover:border-foreground/40 transition-colors">
