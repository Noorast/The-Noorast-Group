          ...
          {dataLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-border/40">
              <div className="py-10 md:pr-12">
                ...
                <Link to="/toolkit/property-passport" className="inline-flex items-center gap-1.5 text-[10px] tracking-[0.12em] uppercase border-b border-foreground/25 pb-0.5 hover:border-foreground/40 transition-colors text-foreground" style={{ textDecoration: 'none' }}>
